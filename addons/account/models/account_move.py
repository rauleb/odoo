...
class AccountPartialReconcile(models.Model):
    ...
    def _get_tax_cash_basis_base_common_vals(self, key, new_move):
        ...
        orig_inv_type = (self.debit_move_id + self.credit_move_id).mapped('invoice_id.type')
        tax_rep_lines = tax.refund_repartition_line_ids if orig_inv_type in ('in_refund', 'out_refund') else tax.invoice_repartition_line_ids
